...
\begin{document}
    ...
    \newpage{
        \centering
            ...
            {\large\bf Решение задач многоэкстремальной оптимизации на основе популяционных алгоритмов. \\ Метод дифференциальной эволюции (вариант генетического алгоритма)} \\
            \vfill
